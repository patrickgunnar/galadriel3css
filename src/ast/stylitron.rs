...
lazy_static! {
    pub static ref STYLITRON: Mutex<LinkedHashMap<String, LinkedHashMap<String, Vec<String>>>> = {
        let mut ast = LinkedHashMap::new();

        // targetChildren declarations
        let mut target_children = LinkedHashMap::new();

        target_children.insert("children".to_string(), vec![]);

        ast.insert("targetChildren".to_string(), target_children);
        ...
        media_query_variables.insert("minSmallPhone".to_string(), vec![]);
        media_query_variables.insert("minMediumPhone".to_string(), vec![]);
        media_query_variables.insert("minSmallTabletPortrait".to_string(), vec![]);
        media_query_variables.insert("minStandardDesktop".to_string(), vec![]);
        media_query_variables.insert("minLargeDesktop".to_string(), vec![]);
        media_query_variables.insert("minXLDesktop".to_string(), vec![]);
        media_query_variables.insert("min4K".to_string(), vec![]);
        media_query_variables.insert("max4K".to_string(), vec![]);
        media_query_variables.insert("maxXLDesktop".to_string(), vec![]);
        media_query_variables.insert("maxLargeDesktop".to_string(), vec![]);
        media_query_variables.insert("maxStandardDesktop".to_string(), vec![]);
        media_query_variables.insert("maxSmallTabletPortrait".to_string(), vec![]);
        media_query_variables.insert("maxMediumPhone".to_string(), vec![]);
        media_query_variables.insert("maxSmallPhone".to_string(), vec![]);
